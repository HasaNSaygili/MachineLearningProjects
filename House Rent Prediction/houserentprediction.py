# -*- coding: utf-8 -*-
"""HouseRentPrediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10_yeTHZugqJHersBaSTKsK1lfa-BTc6g
"""
...
fig = go.Figure(data=[go.Pie(labels=label, values=counts, hole=0.4)])
fig.update_layout(title_text='Number of Houses Available for Different Types Of Tenants')
fig.update_traces(hoverinfo='label+percent', textinfo='value', textfont_size=30,
                  marker=dict(colors=colors, line=dict(color='black', width=3)))
fig.show()
